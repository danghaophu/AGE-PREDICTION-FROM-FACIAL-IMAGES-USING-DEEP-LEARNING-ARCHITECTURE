...
# Decoding
    ...
    age_output = Dense(1, activation='sigmoid')(x)
...
agemodel = gender_unet_model(input_shape)
...
history_gender = agemodel.fit(train_gender, epochs=10, shuffle=True, validation_data=test_gender)
agemodel.save('age_beta.h5')
